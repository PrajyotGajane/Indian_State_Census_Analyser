...
public class CensusAnalyserTest {
      ...
      public void givenStatusCensusCsvFile_WithWrongFileType_ShouldThrowException() {
            try {
                  ...
                  Assert.assertEquals(CensusAnalyserException.ExceptionType.CENSUS_FILE_WRONG_EXTENSION,e.type);
            }
      }
      @Test
      ...
      @Test
      public void givenStatusCensusCsvFile_WithIncorrectDelimiter_ShouldThrowException() {
            try {
                  StateCensusAnalyser censusAnalyser =  new StateCensusAnalyser();
                  ExpectedException exceptionRule = ExpectedException.none();
                  exceptionRule.expect(CensusAnalyserException.class);
